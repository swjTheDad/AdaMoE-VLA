...
class Pi0Config(_model.BaseModelConfig):
    ...
    # MoE configuration
    use_moe: bool = True
    moe_type: _gemma.MoEType = _gemma.MoEType.ADAMOE
    num_experts: int = 4
    top_k: int = 1
    ...
    def get_freeze_filter(self) -> nnx.filterlib.Filter:
        ...
        gating_params_filter = nnx_utils.PathRegex(".*w_gating.*")
...
class Pi0(_model.BaseModel):
    def __init__(self, config: Pi0Config, rngs: nnx.Rngs):
        ...
        # Set MoE configuration for action expert config
        action_expert_config.use_moe = config.use_moe
        action_expert_config.moe_type = config.moe_type
