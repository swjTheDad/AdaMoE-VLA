...
class TrainConfig:
    ...
    # MoE configuration - choose between different MoE implementations
    use_moe: bool = True
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(
            use_moe=True,  # Enable MoE
            moe_type=_gemma.MoEType.CSMOE,  # Use AdaMoE by default
            num_experts=4,
            top_k=1,
        ),
        data=LeRobotLiberoDataConfig(
    ...
    TrainConfig(
        name="Vanilla_MoE_libero",
        model=pi0.Pi0Config(
            use_moe=True,  # Enable MoE
            moe_type=_gemma.MoEType.VANILLA,  # Use AdaMoE by default
            num_experts=4,
            top_k=1,
        ),
        data=LeRobotLiberoDataConfig(
